export default function Footer(){
    return <>
     <footer className="relative container-main z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
...
Gurugram-122022
              ...
              <p className="flex items-center text-sm font-medium text-primary">
                ...
                <a href="tel:8388888001" className="text-secondary font-semibold text-lg">+91 8388888001</a>
              </p>
            </div>
          </div>
        {/*   <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-primary">Resources</h4>
              <ul>
                <li>
                  <a
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-primary">Company</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-primary">Quick Links</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-primary">Follow Us On</h4>
              <div className="mb-6 flex items-center">
                <a className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-primary hover:border-secondary hover:bg-secondary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
                ...
                <a
                  href="javascript:void(0)"
                  className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5]  text-primary hover:border-secondary hover:bg-secondary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="16"
                    height="12"
              ...
              <p className="text-base text-body-color">&copy; 2023 Apollo Clinic</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <span className="absolute left-0 bottom-0 z-[-1]">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#3056D3" stopOpacity
="0.08" />
                <stop offset="1" stopColor="#C4C4C4" stopOpacity
="0" />
              </linearGradient>
            </defs>
          </svg>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#13C296" stopOpacity
="0.31" />
                <stop offset="1" stopColor="#C4C4C4" stopOpacity
="0" />
              </linearGradient>
