        ...
        <div className="flex flex-wrap">
            ...
            >
              ...
              <div className="ud-testimonial-content mb-6">
                <p className="text-base tracking-wide text-body-color">
                  “Amazing experience, painless procedure, highly recommend this clinic for all dental needs.
                </p>
              </div>
              <div className="ud-testimonial-info flex items-center">
                <div className="ud-testimonial-meta">
                  <h4 className="text-sm font-semibold">Neha Gupta</h4>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div className="ud-testimonial-content mb-6">
                <p className="text-base tracking-wide text-body-color">
                  “ Dr. Gaurav is the best dentist in Gurugram, and he always takes the time to explain my treatment options and answer any questions that I may have.
                </p>
              </div>
              <div className="ud-testimonial-info flex items-center">
                <div className="ud-testimonial-meta">
                  <h4 className="text-sm font-semibold">Ridhi varshney </h4>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div className="ud-testimonial-content mb-6">
                <p className="text-base tracking-wide text-body-color">
                  “I have been going to Apollo Dental Gurugram for years now, and I am always impressed by the high level of care and professionalism that I receive.
                </p>
              </div>
              <div className="ud-testimonial-info flex items-center">
                <div className="ud-testimonial-meta">
                  <h4 className="text-sm font-semibold">Mr. Raghav Madan</h4>
                </div>
              </div>
            </div>
          </div>
