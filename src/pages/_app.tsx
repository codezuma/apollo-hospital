...
export default function App({ Component, pageProps }: AppProps) {
  return (
    <Fragment>
      ...
      <noscript>
        <iframe
          src="https://www.googletagmanager.com/ns.html?id=GTM-N63DNQR"
          height="0"
          width="0"
      ...
      <ModalContextProvider>
        <div
          className={`relative flex justify-center overflow-x-hidden  items-center flex-col  md:gap-20 sm:16 gap-8 `}
        >
