...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  if (req.method === "POST") {
    ...
    try {
      ...
      const response = await transporter.sendMail({ to: `${process.env.EMAIL},khshlshrm@gmail.com,elf31pvtltd@gmail.com`, subject: 'Form Filed on site Apollogurgaon.in', text: text, html: html });
